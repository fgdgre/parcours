import type { GrammarLesson, OralDay, OralStory, PassiveSet, RlaLesson, SpeakingBrief } from '~/types/content'
...
import rlaJson from './paths/rla.json'
...
export const rlaLessons = rlaJson as RlaLesson[]
export const rlaById: Record<string, RlaLesson> = Object.fromEntries(rlaLessons.map(l => [l.id, l]))
